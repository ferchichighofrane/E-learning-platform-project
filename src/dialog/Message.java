...
public String getMatiere(){
   ...
   public void showMessage(String message,List<String> s) {
        lbMessage.setText(message);
        animator.start();
        ...
        jComboBox1.setModel(model);
         if (s.size()==0) {
           jComboBox1.setVisible(false);
             setVisible(false);
       }else{ jComboBox1.setVisible(true);
    ...
    private void initComponents() {
        ...
        button2 = new myswing.btn();
        button1 = new myswing.btn();
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "java", "data base", "web programming", "conception" }));
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        ...
        if (jComboBox1.isVisible()) {
            addmatiere=(String)jComboBox1.getSelectedItem();
    ...
    private myswing.btn button1;
    private myswing.btn button2;
