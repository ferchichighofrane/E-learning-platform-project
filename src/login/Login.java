...
public void register(){
     userEntity user = loginAndRegister.getUser();
      if (!userService.verifyEmailformat(user)) {
        
        showMessage(Message.MessageType.ERROR, "Email format is uncorrect");    
    }else try {
...
public void login(){
    ModelLogin data=loginAndRegister.getDataLogin();
        try {
           userEntity user= service.login(data);
            if (user!=null) {
                ...
                showMessage(Message.MessageType.ERROR, "email and password are not correct");
                }
